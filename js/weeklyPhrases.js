...
//   'Push it real good!',
//   'BEST WEEK EVER!!! 🎉🎉🎉',
//   'You submitted your tasks in the form 📮',
//   "You're using the SHEEEEEET",
//   'functions are the building blocks of a program 🧱',
//   'functions can take parameters and pass arguments',
//   'Submit the best clip if you want to be fancy 📎',
//   'A computer will do what you tell it to do',
...
//   'Portfolio & Resume live review Monday @ 6:30pm EST 👀',
//   'Shoutout to Helloitsrufio! 🥳',
//   'Microsoft sponsored stream Thurs 3/31 @ 6:30pm EST',
//   'Friday with Friends @ 6pm EST 🧑‍🤝‍🧑',
//   'Merch! 👙',
//   'Mentor Monday',
//   'Beware the Trough of Sorrow 📉',
//   'BEST WEEK EVER!!! 🎉🎉🎉',
...
//   'Space reptition and active recall',
//   "You're not alone! 🫂",
//   "Let's GIT it on!",
//   'Terminal: place where you can type commands',
//   'CLI > GUI',
//   'pwd shows where you are 📍',
//   'mkdir creates a folder 📁',
//   'cd move to a different folder',
//   'Go up a folder with cd ..',
//   'touch creates a file 📝',
//   'ls shows all files in a folder',
//   'ls -l gives more info about all files in a folder ℹ️',
//   'rm removes a file',
//   'rm -r removes a folder',
//   'careful using rem -rf, it removes everything! 🗑️',
//   'clear will clear your current terminal display',
//   'code <filename> opens the file in VS Code',
//   'Install Git Bash on Windows to access the terminal',
//   'Terminal is found in Applications for Mac & GNU/Linux',
//   'Git is a version control system 💾',
//   'Git commits are like taking snapshots 📸',
//   'You successfully install git 🔧',
//   'git init creates a folder to hold your commits 🗄️',
//   'git add to stage files',
//   'git status shows everyting in staging area',
//   'git commit adds all staged files to your snapshot folder',
//   "Don't forget to comment your commits",
//   'You successfully make a commit 💪',
//   'Branches let you make changes without affecting the rest of your code',
//   'You make a GitHub account',
//   'Use Github for backups and dev tools',
//   'You make a repo on GitHub',
...
//   'API = Application Programming Interface',
//   'An API is a simple interface for some complex action',
//   'API returns a JSON object that we can use within our app',
//   'Leon tries to make fetch happen 👚',
//   "Grandma's car is now YOUR car! 🚗",
//   'A computer will do what you tell it to do',
//   'Programming = writing instructions in a language a computer can understand',
//   'Use query parameters in APIs to return the correct data❓',
//   'You successfully integrate an API into your app',
//   'APIs are like restaurant menus',
//   'You completed a kata on Codewars today ⚔️'
// ];
